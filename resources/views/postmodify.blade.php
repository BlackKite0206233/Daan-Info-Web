...
<head>
    ...
    <script src="kartik-v-bootstrap-fileinput/js/fileinput_locale_fr.js" type="text/javascript"></script>
    <script src="kartik-v-bootstrap-fileinput/js/fileinput_locale_es.js" type="text/javascript"></script>
</head>
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <div class="rows">
                                        ...
                                        <div class="col-md-4 col-xs-4">
                                            <a href="#">
                                                <img class="img-responsive" src="img/powerpoint.png">
                                                <p>簡報下載</p>
                                            </a>
                                        </div>
                                        <div class="col-md-4 col-xs-4">
                                            <a href="#">
                                                <img class="img-responsive" src="img/file.png">
                                                <p>檔案下載</p>
                                            </a>
                                        </div>
                                    </div>
